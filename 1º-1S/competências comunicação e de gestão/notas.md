|Tema: Técnicas de Comunicação e Apresentação|Livro: [Fraleigh & Tuman (2020). Speak Up! An Illustrated Guide to Public Speaking](<Livros/speak up.pdf>)|
|---|---|
|Subtema|Capíulo/subcapítulo|
...
|Comunicação visual|Cap. 12 – Using Presentation Aids|
|IA aplicada à comunicação|integrar no Cap. 12 (apoios visuais) e Cap. 15 (adaptação a diferentes contextos)|

|Tema: Inovação, Ideação e Empreendedorismo|Livro: [Barringer & Ireland (2018). Entrepreneurship: Successfully Launching New Ventures](<Livros/Entrepreneurship.pdf>)|
|---|---|
...
|Tema: Gestão, Estruturas, Processos e Governação|Livro: [Robbins & Coulter (2020). Management (15th edition) parte 1](<Livros/Management1.pdf>) e [Robbins & Coulter (2020). Management (15th edition) parte 2](<Livros/Management2.pdf>)|
|---|---|
|Estruturas organizacionais|Cap. 10 – Basic Organizational Design|
|Coordenação e controlo|Cap. 14 – Control|
|Funções empresariais|Cap. 1 – Management and Organizations|
|Processo organizacional|Cap. 5 – Foundations of Planning + Cap. 10–11|
|Cultura organizacional|Cap. 2 – The Management Environment|
|Gestão por objetivos (KPIs)|Cap. 6 – Strategic Management|
|Ética e responsabilidade|Cap. 3 – Ethics and Social Responsibility|

|Tema: Estratégia, Planeamento e Business Planning| | |
|---|---|---|
|Subtema|Livro|Capítulo|
|Análise PESTEL|[Exploring Strategy](<Livros/Exploring Strategy.pdf>)|Part I – Chapter 3: The Macro-Environment|
|Análise SWOT / TOWS|[Exploring Strategy](<Livros/Exploring Strategy.pdf>)|Part I – Chapter 4: Resources & Capabilities (Forças/Fraquezas) + integração com Chapter 3 (Oportunidades/Ameaças)|
