...
|⊂|Está contido|A está contido em B|A={1,2,3} B={1,2,3,4,5} A ⊂ B|
|⊆|Está contido ou igual|A está contido em B (ou é igual a B)|A={1,2,3} B={1,2,3}  A ⊆ B|
|⊃|Contém|A contém B|A={1,2,3} B={1,2}  A ⊃ B|
|⊇|Contém ou é igual|A contém B ou é igual a B|A={1,2,3} B={1,2,3} A ⊇ B|
|C|Complementar|É o conjunto dos elementos restantes|A= ℤ+ AC= ℤ0-|
|=|Igualdade|Conjuntos com os mesmos elementos|A = B|
|≠|Diferente|Conjuntos diferentes|A ≠ B|
|∪|União|Elementos que estão em A ou em B|A={1,2,3} B={2,4} A ∪ B = {1,2,3,4}|
|∩|Interseção|Elementos que estão em A e em B|A={1,2,3} B={2,3,4}  A ∩ B = {2,3}|
|− ou ∖|Diferença|Elementos que estão em A e não em B|A − B = {1}|
|∅|Conjunto vazio|Conjunto sem elementos|A = ∅ ou A={}|
|U|Conjunto universo|Conjunto com todos os elementos possíveis|U = {1,2,3,4,5}|
|ℕ|Números naturais|{0,1,2,3,…}|
|ℤ|Números inteiros|{…,−2,−1,0,1,2,…}|
|ℚ|Números fracionários|1/2, 3/10, 4/12|
|ℝ|Números reais|√7, π|
